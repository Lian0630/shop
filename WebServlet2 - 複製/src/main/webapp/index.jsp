	...
	<div class="container-fluid">
		...
		<div class="col-sm-6">
			<form id="form-user">
				...
				<div class="inputgroup">
					<button class="mx-2 btn btn-info" onclick="search()" >查詢</button>
					<button class="mx-2 btn btn-primary" onclick="add()">新增</button>
					<button class="mx-2 btn btn-warning" onclick="update()" >修改</button>
					<button class="mx-2 btn btn-danger" onclick="del()" >刪除</button>
