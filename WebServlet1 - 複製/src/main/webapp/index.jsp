	...
	<div class="container-fluid">
		...
		<div class="col-sm-6">
			<form id="form-user" >
				...
				<div class="inputgroup">
					<button type="submit" class="mx-2 btn btn-info" onclick="search()" >查詢</button>
					<button type="submit" class="mx-2 btn btn-primary" onclick="add()">新增</button>
					<button type="submit" class="mx-2 btn btn-warning" onclick="update()" >修改</button>
					<button type="submit" class="mx-2 btn btn-danger" onclick="del()" >刪除</button>
					<button type="submit" class="mx-2 btn btn-info" onclick="getData()">列表</button>
				</div>	
			</form>
		</div>
...
<script type="text/javascript">
	  ...
	  function add() {						
		// 將請求提交到哪
		var url = "UserServlet?method=add";
		// 請求參數
     ...
     function del(){
    	// 將請求提交到哪
 		var url = "UserServlet?method=delete";
